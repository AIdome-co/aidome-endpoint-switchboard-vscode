...
describe('manageProfiles automatic reapply full failure', () => {
  ...
  it('shows an error when edited mapped assistants all fail automatic reapply', async () => {
    ...
    expect(mockShowError).toHaveBeenCalledWith(
      'Profile "OpenAI Prod" updated successfully. Failed to reapply automatic configuration for "OpenAI Prod". Failed assistants: cline.'
    );
  });
});