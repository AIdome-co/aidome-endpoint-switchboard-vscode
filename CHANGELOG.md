...
- Updated Tabnine Enterprise guidance and status reporting for manual server URL configuration, and aligned the GA-readiness documentation and the README quick-reference with the manual (non-auto-verified) Tier C setup.
