  ...
  Upstream: https://github.com/github/awesome-copilot/blob/main/agents/polyglot-test-researcher.agent.md
  License: MIT (see https://github.com/github/awesome-copilot/blob/main/LICENSE)
  Adapted for the AIdome Endpoint Switchboard repo.
-->
---
